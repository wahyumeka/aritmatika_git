		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form">
				...
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					...
					<input class="input100" type="text" name="Masukan Nilai A" placeholder="Enter your name">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<span class="label-input100">Masukan Nilai B</span>
					<input class="input100" type="text" name="Masukan Nilai B" placeholder="Enter your email addess">
					<span class="focus-input100"></span>
				</div>
